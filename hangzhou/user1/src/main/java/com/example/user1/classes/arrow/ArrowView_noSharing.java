package com.example.user1.classes.arrow;
...
public class ArrowView_noSharing extends View {
    ...
    public void addArrow(String startPointName, String endPointName) {
        ...
        if (startPoint != null && endPoint != null) {
            ArrowView.Arrow arrow = new ArrowView.Arrow(startPoint, endPoint, Color.BLUE); // You can set arrow color as per your requirement
            addArrow(arrow);
        }
    }
    ...
    public void updateArrow(Context context) {
        ...
        for (Map.Entry<String, Integer> entry : orderMap.entrySet()) {
            ...
            // 如果下一个景点存在，则添加箭头
            if (endPointName != null&&startUser==1) {
