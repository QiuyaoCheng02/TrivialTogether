...
public class CustomDialogFragment extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        scrollView.getViewTreeObserver().addOnScrollChangedListener(new ViewTreeObserver.OnScrollChangedListener() {
            ...
            public void onScrollChanged() {
                // 在这里记录日志，例如：
                String log="User is scrolling ScrollView" + name1;
                try {
        ...
        int currentOrder= 0;
        currentOrder = dbHelper.getPlaceOrder(name1);
        ...
        if (dialogInfo != null) {
            ...
            intro.setText(dialogInfo.getIntro());
            if(dialogInfo.getTime().equals("1.0")||dialogInfo.getTime().equals("0")||dialogInfo.getTime().equals("0.5")){
        ...
        double finalRemainingTime = remainingTime;
        addButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 创建并显示一个新的Dialog
                if(finalRemainingTime <Double.parseDouble(dialogInfo.getTime())&&b)
                {
        ...
        int finalCurrentOrder = currentOrder;
        minusButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String content=name1+";"+ finalCurrentOrder +";delete";
    ...
    public double getRemainingTime() throws ExecutionException, InterruptedException {
        allocatedTime=dbHelper.calculateAllocatedTime();
        remainingTime=7.0-allocatedTime;

        return remainingTime;
    }
    private void showDialog() throws ExecutionException, InterruptedException {
        // 加载新的Dialog布局文件
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int currentOrder = 0; // 获取当前景点的顺序
                currentOrder = dbHelper.getPlaceOrder(name);
                if (currentOrder == -1) {
                    // >=n 的部分 +1
    ...
    public  void fetchDataAndUpdateSpinner() throws ExecutionException, InterruptedException {
        DBhelper dbHelper = new DBhelper(getContext()); // 实例化DBHelper对象
