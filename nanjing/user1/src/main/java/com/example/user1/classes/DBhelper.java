...
import com.example.user1.User1ConnectionService;
...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public void registerBroadcastReceiver() {
        LocalBroadcastManager.getInstance(context).registerReceiver(mMessageReceiver, new IntentFilter(User1ConnectionService.ACTION_UPDATE_DATABASE));
    }
...
*/
    ...
    private static final String[] DEFAULT_PLACES = {
            AttractionsInfo.ZIJINTA,
            AttractionsInfo.JIUHUASHAN,
            AttractionsInfo.MINGGUGONG,
            AttractionsInfo.XUANWUHU,
            AttractionsInfo.QINGLIANGSHAN,
            AttractionsInfo.ZIJINSHAN,
            AttractionsInfo.JINIANGUAN,
            AttractionsInfo.GULOU,
            AttractionsInfo.YINGZHOU,
            AttractionsInfo.BOWUYUAN,
            AttractionsInfo.ZONGTONGFU,
            AttractionsInfo.JIMINGSI};

    private static final double[] DEFAULT_TIMES = {
            1.5, 2.0, 1.0, 1.5, 1.0, 1.5, 2.0, 1.0, 1.0, 1.5, 1.5, 2.0
    };
