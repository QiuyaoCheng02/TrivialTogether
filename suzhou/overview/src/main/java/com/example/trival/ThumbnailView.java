...
public class ThumbnailView extends View {
    ...
    public void saveThumbnailImage() {
        ...
        Drawable backgroundDrawable = getResources().getDrawable(R.drawable.suzhou_200_a3);
...
*/  // 创建新的 Bitmap 对象
    ...
    public static void saveToFile(List<MyRectF> frameRectList) {
        // 检查要保存到的文件路径
        File file = new File(Environment.getExternalStorageDirectory(), "user1_suzhou.txt");
    ...
    public static void saveToFile1(List<MyRectF> frameRectList) {
        // 检查要保存到的文件路径
        File file = new File(Environment.getExternalStorageDirectory(), "user2_suzhou.txt");
